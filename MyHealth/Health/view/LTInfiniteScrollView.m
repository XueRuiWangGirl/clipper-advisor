...
- (void)setup
{
    self.scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), HEIGHT)];
...
//    CGFloat viewHeight = CGRectGetHeight(self.bounds);
    self.viewSize = CGSizeMake(viewWidth, HEIGHT);
    
    self.totalWidth = viewWidth * self.totalViewCount;
    
    self.scrollView.contentSize = CGSizeMake(self.totalWidth, 0);
